...

{
  ...
  'installable': True, 
  'active': False,
  'description': 'Módulo: SM Códigos - Generador de Etiquetas- El módulo requiere de la instalación especial de la libreria pyBarcode enlace: https://pypi.python.org/pypi/pyBarcode',
