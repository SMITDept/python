...
#  @version     : 1.0                                                                                                                                #
#  @autor       : ARC                                                                                                                               #
#  @creacion    : 2015-08-25 (aaaa/mm/dd)                                                                                                            #
    ...
    * Argumentos OpenERP: [cr, uid, id, name, arg, context]
    ...
    if self._location :
      ...
      if attach.modelo_padre and attach.tipo_documento_m2o_id :
        ...
        fname = self._file_write( cr, uid, self._location, attach.modelo_padre, attach.tipo_documento_m2o_id.descripcion, value )
        print fname
        nombre= attach.tipo_documento_m2o_id.descripcion
        print nombre
